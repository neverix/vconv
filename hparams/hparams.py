...
hparams = Map(
    ...
    model_block_params=("n_sub", "out_channels", "kernel_size", "dropout_prob", "stride", "dilation", "activation"),
    block_params_default=(1, 256, 22, 0.2, 1, 1, F.relu)
)
...
timit = Map(
    ...
    model_blocks=[
        ...
        (1, 896, 29, 0.4, 1, 2),
        (1, 1024, 1, 0.4),
        (1, len(timit.phonemes), 1, 0, 1, 1, F.softmax)
    ],
